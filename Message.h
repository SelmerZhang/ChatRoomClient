...
#define MSG_SENDREQUEST 11  //申请发送
#define MSG_AGREE 12  //同意接收
#define MSG_REFUSE 13  //拒绝接收
#define MSG_FILE 14    //发送文件块
#define MSG_FILETAIL 15    //发送文件尾

#define FILESIZE 30000
